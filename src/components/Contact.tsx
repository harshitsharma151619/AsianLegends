    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="text-2xl font-serif font-bold text-slate-900 mb-6">Find Us Here</h3>
            <div className="bg-slate-200 rounded-lg overflow-hidden h-[500px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3429.408677373156!2d76.8654333!3d29.9746039!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390e471ffa70e7b7%3A0x27bb6820531421d!2sAsian%20Legends%20Restaurant%20%26%20Sky%20Lounge!5e0!3m2!1sen!2sin!4v1709000000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
